...
public class Etal {
	...
	public String libererEtal(){
		...
		try {
			...
			/*Information sur l'erreur qui s'est produite*/
			return e.getMessage();
		}
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) throws IllegalArgumentException,IllegalStateException{
		/*if (etalOccupe) {*/
			if(quantiteAcheter < 1) {
				throw new IllegalArgumentException("La quantité demandée "
						+ "doit être supérieur ou égal à 1");			
			}
			
			if(!etalOccupe) {
				throw new IllegalStateException("Cet étal n'est point"
						+" occupé\n");
			}
